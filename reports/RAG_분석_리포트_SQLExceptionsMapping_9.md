...
- **클래스**: `SQLExceptionsMapping`
- **메서드**: `translateException()`
- **라인**: 122
...
**검색 쿼리**: `SQLExceptionsMapping translateException`

### 1. CustomerService.java (유사도: -34.72%)
...
### 2. PolicySearchMapper.java (유사도: -34.86%)
...
### 3. CustomerService.java (유사도: -39.42%)
